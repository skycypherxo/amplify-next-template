    ...
    <div className="w-full  h-full lg:h-full overflow-hidden min-h-screen bg-white space-y-6 text-black flex relative mx-auto flex-col items-center">
      <div className="absolute opacity-70 top-0 left-0 z-0">
        <Image
          ...
          height={600}
          alt="triangle"
          src="/images/tri_left.png"
          sizes="(max-width: 768px) 300px, (max-width: 1024px) 450px, 600px"
        />
      </div>
      <div className="absolute opacity-70 lg:-translate-y-8 top-0 right-0 z-0">
        <Image
          width={600}
          height={600}
          alt="triangle"
          src="/images/tri_right.png"
          sizes="(max-width: 768px) 300px, (max-width: 1024px) 450px, 600px"
        />
      </div>
      ...
      <div className="relative z-10 flex items-center justify-center flex-col">
        <div className="z-2 lg:w-7/12 w-full mt-2 space-y-3 px-4 lg:px-0 mb-10 lg:mb-0">
          ...
          <div className="relative flex justify-center">
            <p className="font-bold text-page-blue xl:text-6xl lg:text-5xl md:text-4xl sm:text-3xl text-2xl z-10 border-b-4 border-page-blue xl:pb-2 md:pb-1 mb-4 px-12 text-center">
              PARTNERS
            </p>
            <p className="absolute text-page-blue  font-extrabold xl:text-[130px] lg:text-[80px] md:text-[60px] text-[40px] z-0 opacity-10 xl:top-[-80%] lg:top-[-50%] md:top-[-40 %] top-[-25%] tracking-widest">
            PARTNERS
          </p>
          </div>
          ...
          <div className="lg:flex  flex items-center justify-center">
            <img
              ...
              width={"175"}
              className=""
              src="./images/partner_gov_logo.jpg"
            ></img>
          </div>
        </div>
        <div className="mb-10 lg:mb-0">
          <img height={"150px"} width={"1000px"} src="./images/partner_bottom.jpg"></img>
        </div>
      </div>
    </div>
  );
